...
class menu_cadastro:  # Criação da classe.
    ...
    def menucadastro(self):  # Configuração do menu
        ...
        self.menu.geometry('800x900+600+150')
    ...
    def entradadados(self):  # Criação dos campos da entrada de dados.
        ...
        self.entrada_complemento.place(relx=0.27, rely=0.40, relheight=0.03, relwidth=0.30)
        ...
        self.entrada_telefone.place(relx=0.09, rely=0.54, relheight=0.03, relwidth=0.26)
    ...
    def botoes(self):
        ...
        self.select_limpar = Button(self.menu, text='Limpar')
        self.select_limpar.place(relx=0.09, rely=0.39, relheight=0.04, relwidth=0.15)
